...
describe 'ip conflict detection' do
  ...
  context 'when testing with fully qualified network names' do
    context 'when a VM already exists on network' do
      context 'when the VM exists on a different network with same unqualified name' do
      ...
      context 'when the VM exists on a same network with same unqualified name' do
